...
{{-- Announcement Banner --}}
<div class="bg-[#7a4b2b] text-white text-center py-2.5 text-xs tracking-wider inline-flex items-center justify-center gap-2">
    <i class="fa-solid fa-gift"></i> Gratis ongkir untuk pembelian min. Rp 150.000
