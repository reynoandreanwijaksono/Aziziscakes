...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
    @foreach([
        ...
        ['<i class="fa-solid fa-shopping-bag"></i>','Total Pesanan', number_format($stats['total_orders']), 'text-purple-600','bg-purple-50', route('admin.orders.index')],
        ['<i class="fa-solid fa-users"></i>','Total User', number_format($stats['total_users']), 'text-green-600','bg-green-50', '#'],
        ['<i class="fa-solid fa-globe"></i>','Website Content', 'Edit konten website', 'text-teal-600','bg-teal-50', route('admin.settings.website.index')],
        ['<i class="fa-solid fa-coins"></i>','Total Revenue', 'Rp ' . number_format($stats['total_revenue'],0,',','.'), 'text-[#7a4b2b]','bg-[#fef3ec]', route('admin.payments.index')],
    ] as $card)
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-8">
    <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
        <h3 class="font-semibold text-gray-700 mb-1"><i class="fa-solid fa-hourglass-end mr-2"></i>Pesanan Pending</h3>
    ...
    <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
        <h3 class="font-semibold text-gray-700 mb-1"><i class="fa-solid fa-calendar-days mr-2"></i>Revenue Bulan Ini</h3>
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
    ...
    <div class="lg:col-span-2 bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
            <h3 class="font-semibold text-gray-700"><i class="fa-solid fa-box mr-2"></i>Pesanan Terbaru</h3>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-100">
            <h3 class="font-semibold text-gray-700"><i class="fa-solid fa-fire mr-2"></i>Produk Terlaris</h3>
        </div>
