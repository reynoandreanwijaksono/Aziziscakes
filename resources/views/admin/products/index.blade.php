...
<div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
    ...
    <a href="{{ route('admin.products.create') }}"
       class="bg-[#7a4b2b] text-white px-5 py-2.5 rounded-xl text-sm font-medium hover:bg-[#5a3825] transition-colors flex items-center justify-center gap-2 w-full md:w-auto flex-shrink-0">
        + Tambah Produk
    </a>
</div>
